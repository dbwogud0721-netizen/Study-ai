...
import { MATH_QUESTION_BANK, SCIENCE_QUESTION_BANK } from './generated/subjectQuestionBank'

const now = () => new Date().toISOString()

const HANDWRITTEN_QUESTIONS: Question[] = [
  // ── 중학교 수학 (3학년) ──────────────────────────
  {
    ...
    concept: '이차함수의 꼭짓점', questionType: '개념 적용', estimatedDifficulty: 0.55, sourceType: 'ai_generated', createdAt: now(), tags: ['이차함수', '꼭짓점'],
  },
  {
    ...
    concept: '이차함수의 축', questionType: '개념 적용', estimatedDifficulty: 0.3, sourceType: 'ai_generated', createdAt: now(), tags: ['이차함수', '축'],
  },
  {
    ...
    concept: '이차함수의 그래프 특성', questionType: '추론', estimatedDifficulty: 0.75, sourceType: 'ai_generated', createdAt: now(), tags: ['이차함수', '그래프'],
  },
  {
    ...
    concept: '근과 계수의 관계', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['이차방정식', '근'],
  },
  {
    ...
    concept: '삼각비 값', questionType: '계산', estimatedDifficulty: 0.5, sourceType: 'ai_generated', createdAt: now(), tags: ['삼각비', '특수각'],
  },
  {
    ...
    concept: '대푯값', questionType: '계산', estimatedDifficulty: 0.35, sourceType: 'ai_generated', createdAt: now(), tags: ['통계', '중앙값'],
  },
  {
    ...
    concept: '현의 길이', questionType: '계산', estimatedDifficulty: 0.7, sourceType: 'ai_generated', createdAt: now(), tags: ['원', '현'],
  },
  {
    ...
    concept: '열분해 반응', questionType: '개념 이해', estimatedDifficulty: 0.45, sourceType: 'ai_generated', createdAt: now(), tags: ['화학반응', '열분해'],
  },
  {
    ...
    concept: '기압과 날씨', questionType: '개념 이해', estimatedDifficulty: 0.3, sourceType: 'ai_generated', createdAt: now(), tags: ['기압', '날씨'],
  },
  {
    ...
    concept: '무조건 반사', questionType: '개념 이해', estimatedDifficulty: 0.5, sourceType: 'ai_generated', createdAt: now(), tags: ['신경계', '반사'],
  },
  ...
  // ── 중학교 국어 (3학년) ──────────────────────────
  {
    ...
    concept: '문학 감상 관점', questionType: '개념 이해', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['문학', '감상관점'],
  },
  {
    ...
    concept: '언어의 본질', questionType: '개념 이해', estimatedDifficulty: 0.3, sourceType: 'ai_generated', createdAt: now(), tags: ['언어', '자의성'],
  },
  {
    ...
    concept: '논증의 타당성', questionType: '적용', estimatedDifficulty: 0.35, sourceType: 'ai_generated', createdAt: now(), tags: ['작문', '논증'],
  },
  ...
  // ── 중학교 영어 (3학년) ──────────────────────────
  {
    ...
    concept: '관계부사', questionType: '문법', estimatedDifficulty: 0.5, sourceType: 'ai_generated', createdAt: now(), tags: ['문법', '관계부사'],
  },
  {
    ...
    concept: '어휘와 품사', questionType: '어휘', estimatedDifficulty: 0.3, sourceType: 'ai_generated', createdAt: now(), tags: ['어휘', '품사'],
  },
  {
    ...
    concept: '명사절 작문', questionType: '작문', estimatedDifficulty: 0.55, sourceType: 'ai_generated', createdAt: now(), tags: ['작문', '명사절'],
  },
  ...
  // ── 중학교 사회 (3학년) ──────────────────────────
  {
    ...
    concept: '권력 분립', questionType: '개념 이해', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['정치', '권력분립'],
  },
  {
    ...
    concept: '문화 이해 태도', questionType: '개념 이해', estimatedDifficulty: 0.3, sourceType: 'ai_generated', createdAt: now(), tags: ['문화', '상대주의'],
  },
  {
    ...
    concept: '인구 변화', questionType: '추론', estimatedDifficulty: 0.45, sourceType: 'ai_generated', createdAt: now(), tags: ['인구', '고령화'],
  },
  ...
  // ── 중학교 역사 (3학년) ──────────────────────────
  {
    ...
    concept: '민족 독립운동', questionType: '사실 확인', estimatedDifficulty: 0.35, sourceType: 'ai_generated', createdAt: now(), tags: ['역사', '독립운동'],
  },
  {
    ...
    concept: '민주화 운동', questionType: '사실 확인', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['역사', '민주화'],
  },
  ...
  // ── 중학교 1·2학년 수학 (curriculum 매칭용) ──────
  {
    ...
    concept: '일차방정식 풀이', questionType: '계산', estimatedDifficulty: 0.25, sourceType: 'ai_generated', createdAt: now(), tags: ['방정식'],
  },
  {
    ...
    concept: '일차함수 그래프', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['일차함수'],
  },
  {
    ...
    concept: '수학적 확률', questionType: '계산', estimatedDifficulty: 0.5, sourceType: 'ai_generated', createdAt: now(), tags: ['확률'],
  },
  ...
  // ── 고등학교 공통수학 (1학년) ────────────────────
  {
    ...
    concept: '다항식의 곱셈', questionType: '계산', estimatedDifficulty: 0.35, sourceType: 'ai_generated', createdAt: now(), tags: ['다항식'],
  },
  {
    ...
    concept: '판별식', questionType: '계산', estimatedDifficulty: 0.6, sourceType: 'ai_generated', createdAt: now(), tags: ['이차방정식', '판별식'],
  },
  {
    ...
    concept: '두 점 사이의 거리', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['좌표평면'],
  },
  ...
  // ── 고등학교 대수 / 미적분Ⅰ / 확률과 통계 (2학년) ──
  {
    ...
    concept: '로그의 정의', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['로그'],
  },
  {
    ...
    concept: '등차수열의 일반항', questionType: '계산', estimatedDifficulty: 0.55, sourceType: 'ai_generated', createdAt: now(), tags: ['수열'],
  },
  {
    ...
    concept: '다항함수의 미분', questionType: '계산', estimatedDifficulty: 0.45, sourceType: 'ai_generated', createdAt: now(), tags: ['미분'],
  },
  {
    ...
    concept: '함수의 극한', questionType: '계산', estimatedDifficulty: 0.6, sourceType: 'ai_generated', createdAt: now(), tags: ['극한'],
  },
  {
    ...
    concept: '순열', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['순열'],
  },
  {
    ...
    concept: '독립사건의 확률', questionType: '계산', estimatedDifficulty: 0.55, sourceType: 'ai_generated', createdAt: now(), tags: ['확률', '독립사건'],
  },
  ...
  // ── 고등학교 공통국어 / 독서 / 영어Ⅰ ────────────
  {
    ...
    concept: '독서 방법', questionType: '개념 이해', estimatedDifficulty: 0.35, sourceType: 'ai_generated', createdAt: now(), tags: ['독서'],
  },
  {
    ...
    concept: '추론적 읽기', questionType: '추론', estimatedDifficulty: 0.55, sourceType: 'ai_generated', createdAt: now(), tags: ['독서', '추론'],
  },
  {
    ...
    concept: '관용 표현 추론', questionType: '어휘', estimatedDifficulty: 0.6, sourceType: 'ai_generated', createdAt: now(), tags: ['어휘', '관용표현'],
  },
  ...
  // ── 고등학교 통합사회 / 통합과학 (1학년) ─────────
  {
    ...
    concept: '기본권 구제', questionType: '개념 이해', estimatedDifficulty: 0.45, sourceType: 'ai_generated', createdAt: now(), tags: ['헌법', '기본권'],
  },
  {
    ...
    concept: '뉴턴 운동 제2법칙', questionType: '계산', estimatedDifficulty: 0.4, sourceType: 'ai_generated', createdAt: now(), tags: ['역학', '힘'],
  },
]

export const MOCK_QUESTIONS: Question[] = [
  ...HANDWRITTEN_QUESTIONS,
  ...KOREAN_QUESTION_BANK,
  ...MATH_QUESTION_BANK,
...
/** taxonomy 기반 영역별 문제 조회. majorArea만 넘기면 대영역 전체, middleArea/minorArea로 좁힐 수 있다. */
export const getQuestionsByArea = (
  ...
  const filtered = MOCK_QUESTIONS.filter(
    (q) =>
      q.subject === subject &&
      q.majorArea === majorArea &&
      (!middleArea || q.middleArea === middleArea) &&
      (!minorArea || q.minorArea === minorArea)
  )
